...
Your goal is to pair every rider wearing a red shirt with a
...
def tandemBicycle(redShirtSpeeds, blueShirtSpeeds, fastest):
    ...
    speeds_in_pairs = list(zip(redShirtSpeeds, blueShirtSpeeds))

    total_speed = 0

    for tandem in speeds_in_pairs:
        total_speed += max(tandem)
